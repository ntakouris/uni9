...
insert into etaireia (
AFM,          DOY,          name,              tel,        street,           num, city,       country) values 
...
('Computer Science',               'Root element, most general antikeim',          NULL),
...
username,     bio, sistatikes, certificates) values
...
('Lyceum certificate',                     '2nd Lyceum of Aigaleo',              'LYKEIO'),
...
cand_usrname, degr_title,                               degr_idryma,                          etos, grade) values 
('cleogeo',   'Lyceum certificate',                     '2nd Lyceum of Aigaleo',              1999, 19.2),
...
insert into job (
start_date,    salary, position,                        edra,               recruiter,  announce_date, submission_date) values 
